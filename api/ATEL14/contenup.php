...
<script src="js/script.js"></script>
 ...
 <div class="container">
            <div class="row"> 
               <h4 class="ml-5 mt-2"> <span style="font-family:Georgia" class="text-black" >  Votre Panier :</span></h4><a href="contenup.php"> <img src="images/panier.png"  class="ml-2" width="60" height="60"/></a>
...
<table class="table table-striped table-bordered">
           ...
           foreach ($contenup as $achat) 
               ...
               echo " <input type='hidden'   name='iditem'  value='$iditem'>";
                 ...
                 echo " <td><input type='number' name='newqte'><input type='submit' value='Modifier'   name='updatepanier'/></td>";
                  echo " <td><input type='submit' value='Supprimer'   name='deletepanier'/></td>";
                  echo " </form>";
               echo " </tr>";                
               }        
                     ...
                     <a  href='paiement.php' class="btn btn-warning">Continuer</a>
                     <?php 
                     }
                     ?>     
                 </section>
